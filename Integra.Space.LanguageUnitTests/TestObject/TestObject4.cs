...
{
    public class TestObject4 : InputBase
    {
        public TestObject4(string messageType = "0110", string primaryAccountNumber = "9999941616073663_2", string processingCode = "302000", decimal transactionAmount = 1000m, string dateTimeTransmission = "0508152549", string systemTraceAuditNumber = "212868", string localTransactionTime = "152549"
