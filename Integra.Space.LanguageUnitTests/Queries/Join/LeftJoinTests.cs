...
namespace Integra.Space.LanguageUnitTests.Queries
{
    ...
    public class LeftJoinTests : ReactiveTest
    {
        ...
        public void LeftJoinTest_MixedSources_1()
        {
            ...
            {
                Assert.AreEqual<string>(string.Format("CompilationException: Line: {0}, Column: {1}, Instruction: {2}, Error: {3}", 0, 68, string.Empty, Integra.Space.Language.Resources.COMPILATION_ERRORS.CE77("t2")), e.InnerException.InnerException.Message);
                return;
            }
        ...
        public void LeftJoinTest_MixedSources_2()
        {
            ...
            {
                Assert.AreEqual<string>(string.Format("CompilationException: Line: {0}, Column: {1}, Instruction: {2}, Error: {3}", 0, 152, string.Empty, Integra.Space.Language.Resources.COMPILATION_ERRORS.CE77("t1")), e.InnerException.InnerException.Message);
                return;
            }
