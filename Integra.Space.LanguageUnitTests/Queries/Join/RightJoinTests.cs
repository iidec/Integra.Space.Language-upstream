    ...
    public class RightJoinTests : ReactiveTest
    {
        ...
        public void RightJoinMultipleEventsTest_OnTrue()
        {
            ...
            ReactiveAssert.AreElementsEqual(new Recorded<Notification<object>>[] {
                    ...
                    OnNext(results.Messages.ElementAt(4).Time,(object)(new { c1 = (object)null, c2 = (object)"9999941616073663_2" }))
                }, results.Messages);
        }
        ...
        public void RightJoinTest_MixedSources_2()
        {
            ...
            {
                Assert.AreEqual<string>(string.Format("CompilationException: Line: {0}, Column: {1}, Instruction: {2}, Error: {3}", 0, 153, string.Empty, Language.Resources.COMPILATION_ERRORS.CE77("t1")), e.InnerException.InnerException.Message);
                return;
            }
