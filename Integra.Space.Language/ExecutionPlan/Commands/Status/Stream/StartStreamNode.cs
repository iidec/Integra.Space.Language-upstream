...
namespace Integra.Space.Language
{
    ...
    /// </summary>
    internal sealed class StartStreamNode : StartNode 
    {
        /// <summary>
        ...
        public StartStreamNode(string identifier, int line, int column, string nodeText) : base(SpaceObjectEnum.Stream, identifier, line, column, nodeText)
        {
