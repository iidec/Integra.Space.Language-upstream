...
namespace Integra.Space.Language
{
    ...
    internal class RevokePermissionNode : SpacePermissionsCommandNode
    {
        ...
        public RevokePermissionNode(SpaceObjectEnum spaceObjectType, string toIdentifier, List<SpacePermission> permissions, int line, int column, string nodeText) : base(SpaceActionCommandEnum.Revoke, spaceObjectType, toIdentifier, permissions, line, column, nodeText)
        {
        }
    }
}
