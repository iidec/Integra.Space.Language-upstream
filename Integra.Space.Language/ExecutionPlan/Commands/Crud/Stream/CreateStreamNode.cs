...
namespace Integra.Space.Language
{
    ...
    /// </summary>
    internal sealed class CreateStreamNode : CreateObjectNode
    {
        /// <summary>
        ...
        public CreateStreamNode(string query, string identifier, int line, int column, string nodeText) : base(identifier, line, column, nodeText)
        {
            this.query = query;
        }
    }
