...
namespace Integra.Space.Language
{
    ...
    /// </summary>
    internal sealed class CreateSourceNode : CreateObjectNode
    {
        /// <summary>
        ...
        public CreateSourceNode(string identifier, int line, int column, string nodeText) : base(Common.SpaceObjectEnum.Source, identifier, line, column, nodeText)
        {
        }
    }
}
