...
namespace Integra.Space.Language
{
    ...
    /// </summary>
    internal abstract class DropObjectNode : SpaceCrudCommandNode
    {
        /// <summary>
        ...
        public DropObjectNode(string identifier, int line, int column, string nodeText) : base(identifier, line, column, nodeText)
        {
        }
    }
}
