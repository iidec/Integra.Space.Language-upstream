...
namespace Integra.Space.Language
{
    ...
    internal sealed class CreateSchemaNode : CreateObjectNode<SchemaOptionEnum>
    {
        ...
        public CreateSchemaNode(CommandObject commandObject, Dictionary<SchemaOptionEnum, object> options, int line, int column, string nodeText, string databaseName) : base(commandObject, options, line, column, nodeText, null, databaseName)
        {
        }
    }
}
