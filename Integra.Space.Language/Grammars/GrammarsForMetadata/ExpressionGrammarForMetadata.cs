...
namespace Integra.Space.Language.Grammars
{
    ...
    internal sealed class ExpressionGrammarForMetadata : InterpretedLanguageGrammar
    {
        ...
        public void Grammar()
        {
            ...
            this.values = new NonTerminal("VALUE_FOR_METADATA", typeof(PassASTNode));
            this.values.AstConfig.NodeType = null;
            this.values.AstConfig.DefaultNodeCreator = () => new PassASTNode();
            this.numericValues = new NonTerminal("NUMERIC_VALUES_FOR_METADATA", typeof(PassASTNode));
            ...
            this.otherValues = new NonTerminal("OTHER_VALUES_FOR_METADATA", typeof(PassASTNode));
            this.otherValues.AstConfig.NodeType = null;
            this.otherValues.AstConfig.DefaultNodeCreator = () => new PassASTNode();
            NonTerminal nt_DATETIME_TIMESPAN_VALUES = new NonTerminal("DATETIME_TIMESPAN_VALUES_FOR_METADATA", typeof(PassASTNode));
            ...
            this.projectionValue = new NonTerminal("PROJECTION_VALUES_FOR_METADATA", typeof(PassASTNode));
