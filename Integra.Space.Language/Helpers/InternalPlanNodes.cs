...
namespace Integra.Space.Language
{
    ...
    internal sealed class InternalPlanNodes
    {
        ...
        {
            /******************************************************************************************************************************************/
            PlanNode never = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.ObservableNever);
            never.Children = new List<PlanNode>();
                        
            PlanNode timeout = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.ObservableTimeout);
            timeout.Properties.Add("ReturnObservable", false);
            timeout.Children = new List<PlanNode>();
            timeout.Children.Add(never);
            timeout.Children.Add(timespanValue);
            /******************************************************************************************************************************************/
            PlanNode fromForLambdaLeftWhere = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.ObservableFromForLambda);
            fromForLambdaLeftWhere.Properties.Add("ParameterPosition", parameterPosition);

            PlanNode getStateProperty = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.Property);
            ...
            PlanNode constantExpiredState = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.Constant);
            ...
            PlanNode equalNode = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.Equal);
            equalNode.Children = new List<PlanNode>();
            equalNode.Children.Add(getStateProperty);
            equalNode.Children.Add(constantExpiredState);
            /******************************************************************************************************************************************/
            PlanNode fromForLambdaLeft1 = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.ObservableFromForLambda);
            ...
            PlanNode newScopeLeftWhere = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.NewScope);
            ...
            PlanNode leftWhere = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.EnumerableWhere);
            leftWhere.Children = new List<PlanNode>();
            leftWhere.Children.Add(newScopeLeftWhere);
            leftWhere.Children.Add(equalNode);
            /******************************************************************************************************************************************/
            PlanNode newScopenumerableLeftSelect = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.NewScope);
            ...
            PlanNode fromForLambdaLeftSelect = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.ObservableFromForLambda);
            fromForLambdaLeftSelect.Properties.Add("ParameterPosition", parameterPosition);

            PlanNode leftDurationProjection = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.JoinProjection);
            ...
            /******************************************************************************************************************************************/
            PlanNode leftSelect = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.EnumerableSelectForEnumerable);
            ...
            PlanNode toObservable = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.EnumerableToObservable);
            toObservable.Children = new List<PlanNode>();
            toObservable.Children.Add(leftSelect);
            /******************************************************************************************************************************************/
            PlanNode newScope1 = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.NewScope);
            ...
            PlanNode catchNode = new PlanNode(timespanValue.Line, timespanValue.Column, PlanNodeTypeEnum.ObservableCatch);
            catchNode.Children = new List<PlanNode>();
