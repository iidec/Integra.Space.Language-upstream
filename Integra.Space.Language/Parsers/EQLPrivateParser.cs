//-----------------------------------------------------------------------
// <copyright file="EQLPrivateParser.cs" company="Integra.Space.Language">
    ...
    internal sealed class EQLPrivateParser
    {
        ...
        public List<PlanNode> Parse()
        {
            ...
            try
            {
                ...
                {
                    Irony.Interpreter.ScriptApp app = new Irony.Interpreter.ScriptApp(new Integra.Space.Language.Grammars.PrivateLanguageRuntime());
