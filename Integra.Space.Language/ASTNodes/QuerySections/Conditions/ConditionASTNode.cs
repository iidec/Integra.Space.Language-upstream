//-----------------------------------------------------------------------
// <copyright file="ConditionASTNode.cs" company="Integra.Space.Language">
...
namespace Integra.Space.Language.ASTNodes.QuerySections
{
    ...
    /// ConditionNode class
    /// </summary>
    internal class ConditionASTNode : AstNodeBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConditionASTNode"/> class
        /// </summary>
