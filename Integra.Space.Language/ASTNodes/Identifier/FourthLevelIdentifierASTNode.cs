//-----------------------------------------------------------------------
// <copyright file="FourthLevelIdentifierASTNode.cs" company="Integra.Space.Language">
...
namespace Integra.Space.Language.ASTNodes.Identifier
{
    ...
    /// </summary>
    internal sealed class FourthLevelIdentifierASTNode : AstNodeBase
    {
        /// <summary>
        /// Object identifier.
        /// </summary>
        ...
        public override void Init(AstContext context, ParseTreeNode treeNode)
        {
            ...
            {
                this.schemaName = (string)ChildrenNodes[0].Token.Value;
            ...
            else if (ChildrenNodes.Count == 3)
            {
                ...
                this.schemaName = (string)ChildrenNodes[1].Token.Value;
        ...
        {
            return Tuple.Create(this.databaseName, this.schemaName, this.identifier);
        }
    }
}
