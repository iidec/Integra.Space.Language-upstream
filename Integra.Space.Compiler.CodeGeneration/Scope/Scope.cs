...
namespace Integra.Space.Compiler
{
    ...
    internal sealed class Scope
    {
        ...
        public ParameterExpression GetParameterByType(params System.Type[] type)
        {
            ...
            if (param == null)
            {
                throw new Language.Exceptions.CompilationException(string.Format("Variable with type {0} not found", type));
            }
        ...
        public ParameterExpression GetParameterByGenericType(int index, params System.Type[] genericType)
        {
            ...
            if (param == null)
            {
                throw new Language.Exceptions.CompilationException(string.Format("Variable with type {0} not found", genericType));
            }
        ...
        public ParameterExpression GetFirstParameter()
        {
            ...
            {
                throw new Language.Exceptions.CompilationException("No parameter defined.");
            }
        }
        ...
        public ParameterExpression GetParameterByIndex(int index)
        {
            ...
            {
                throw new Language.Exceptions.CompilationException(string.Format("No parameter at the specified index {0}.", index));
            }
        }
        ...
        public void AddParameter(ParameterExpression param)
        {
            ...
            {
                throw new Language.Exceptions.CompilationException(string.Format("The variable already exists in this scope."));
            }
        }
    }
}
