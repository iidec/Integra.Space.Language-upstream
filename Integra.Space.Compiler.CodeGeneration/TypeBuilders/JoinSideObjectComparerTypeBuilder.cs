...
namespace Integra.Space.Compiler
{
    ...
    internal class JoinSideObjectComparerTypeBuilder : SpaceTypeBuilder
    {
        ...
        public JoinSideObjectComparerTypeBuilder(AssemblyBuilder asmBuilder, List<FieldNode> listOfFields, Type parentType, Type typeOfTheOtherSource, bool isSecondSource, LambdaExpression onCondition) : base(asmBuilder, "SpaceJoinSideObjectComparer_" + parentType.Name, parentType, listOfFields)
        {
