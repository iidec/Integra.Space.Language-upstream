...
namespace Integra.Space.Compiler
{
    ...
    internal class QueryResultTypeBuilder : SpaceTypeBuilder
    {
        ...
        public QueryResultTypeBuilder(AssemblyBuilder asmBuilder, string queryId, Type resultArrayType) : base(asmBuilder, "SpaceQueryResult_" + queryId, typeof(QueryResult<>).MakeGenericType(resultArrayType), Enumerable.Empty<FieldNode>())
        {
        }
