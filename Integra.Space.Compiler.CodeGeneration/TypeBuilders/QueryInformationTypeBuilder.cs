...
namespace Integra.Space.Compiler
{
    ...
    internal class QueryInformationTypeBuilder : SpaceTypeBuilder
    {
        ...
        public QueryInformationTypeBuilder(AssemblyBuilder asmBuilder, string queryId, Type queryType) : base(asmBuilder, "QueryInformartion_" + queryId, typeof(object), Enumerable.Empty<FieldNode>())
        {
